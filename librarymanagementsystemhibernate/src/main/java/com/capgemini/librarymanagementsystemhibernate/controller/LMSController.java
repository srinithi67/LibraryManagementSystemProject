												...
												try {
													...
													for (Book bookBean : bookauthor) {
														...
														if (bookBean != null) {
															...
															System.out.println(
																	"Book_Author is-->" + bookBean.getAuthorName());
															System.out.println("Book_Publications is-->"
												...
												try {
													...
													for (RequestDetails requestBean : requests) {
														if (requestBean != null) {
															...
															System.out
																	.println("Email id is-->" + requestBean.getEmail());
															System.out.println(
																	"BookName is-->" + requestBean.getBookName());
														} else {
															System.out.println(
																	"-----------------------------------------------");
												...
												try {
													...
													for (BookIssueDetails issueBean : issuedBooks) {
														if (issueBean != null) {
															...
															System.out.println("Book_Id is-->" + issueBean.getBId());
															System.out.println(
																	"Issue_Date is-->" + issueBean.getIssueDate());
															System.out.println(
												...
												try {
													...
													for (User Bean : users) {
														if (Bean != null) {
															...
															System.out
																	.println("First_Name is-->" + Bean.getFirstName());
													...
													if (loginInfo.getUId() == user_Id) {
														...
														for (BorrowedBooks bookBean : borrowedBookList) {
															...
															if (bookBean != null) {
																...
																System.out.println("Book_Id is-->" + bookBean.getBId());
																System.out.println(
																		"Email Id is-->" + bookBean.getBookName());
															} else {
																System.out.println(
																		"-----------------------------------------------");
