package com.capgemini.librarymanagementsystemspringrest.validation;
...
public class LMSValidation {
	...
	public boolean validatedMobile(long mobile) throws LMSException {
		...
		if (Pattern.matches(mobileRegEx, String.valueOf(mobile))) {
			...
			throw new LMSException("Mobile Number will start with  6,7,8,9 and It should contains 10 numbers");
		}
		return result;
	}
